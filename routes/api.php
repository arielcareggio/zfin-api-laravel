...
Route::middleware('auth:sanctum')->group(function () {
    ...
    //Cuentas
    Route::post('/cuentas/getCuenta',        'App\Http\Controllers\CuentasController@getCuenta');
    ...
    //Totales de cuentas
    Route::post('/totales/getTotales',        'App\Http\Controllers\TotalesController@getTotales');

    //Personas
    Route::post('/personas/getPersonas',        'App\Http\Controllers\PersonasController@getPersonas');
    ...
    //Bancos
    Route::post('/bancos/getBancos',        'App\Http\Controllers\BancosController@getBancos');
    ...
    //Bancos Cuentas
    Route::post('/bancosCuentas/getBancosCuentas',        'App\Http\Controllers\BancosCuentasController@getBancosCuentas');
    ...
    //Tipos Movimientos
    Route::post('/movimientosTipos/getMovimientosTipos',        'App\Http\Controllers\MovimientosTiposController@getMovimientosTipos');
    ...
    //Movimientos
    Route::post('/movimientos/getMovimientos',        'App\Http\Controllers\MovimientosController@getMovimientos');
    ...
    Route::post('/movimientosAccesosDirectos/getMovimientosAccesosDirectos',        'App\Http\Controllers\MovimientosAccesosDirectosController@getMovimientosAccesosDirectos');
